...
const flushQuotes = [ "It’s flush time, baby. Let those roots sip that spa water.", "No nutes. No worries. Just vibes.", "The only thing we’re feeding now is your ego before harvest.", "You’ve entered the cleanse. Namaste, nutrient salts.", "She’s on a diet. Just water and compliments.", "The plants are fasting. Let them reflect.", "You did your part. Now let osmosis handle the rest.", "Nutrient rehab: Day 1. She’s gonna make it.", "No more powder. No more liquids. Just liquid vibes.", "The only ‘P’ she’s getting now is peace.", "This is the part where we ghost our nutrients.", "Flushing: because even queens need a reset.", "All gas, no nutes.", "T-minus 7 days until trim jail.", "This is her juice cleanse. Respect it.", "Hydrated. High. And ready to harvest.", "We’ve stopped feeding. She's still greedy.", "Flush it real good.", "Just vibes and H₂O now, my dude.", "No nutes. Just Newts. (Wait, why is there a newt in the tent?)" ];

export default function App() { const [startingEC, setStartingEC] = useState(""); const [targetEC, setTargetEC] = useState(""); const [gallons, setGallons] = useState(1); const [phase, setPhase] = useState("veg"); const [system, setSystem] = useState("maxi"); const [nutrients, setNutrients] = useState(null); const [flushQuote, setFlushQuote] = useState(null);

const ratios = { maxi: { MaxiGrow: 1.8, MaxiBloom: 1.5, KoolBloom: 1.0, }, gh3: { veg: { Micro: 5, Gro: 10, Bloom: 5, KoolBloom: 0 }, early: { Micro: 5, Gro: 5, Bloom: 10, KoolBloom: 0 }, mid: { Micro: 5, Gro: 2.5, Bloom: 12.5, KoolBloom: 2.5 }, late: { Micro: 5, Gro: 0, Bloom: 15, KoolBloom: 5 }, flush: { Micro: 0, Gro: 0, Bloom: 0, KoolBloom: 0 }, }, };
...
const phaseColors = { veg: "bg-green-600", early: "bg-yellow-500", mid: "bg-orange-500", late: "bg-red-500", flush: "bg-blue-400", };

return ( <div className="p-6 max-w-xl mx-auto text-gray-900"> <h1 className="text-3xl font-bold mb-6 text-center">Chronic Worm Farmer Nutrient Calculator</h1>
