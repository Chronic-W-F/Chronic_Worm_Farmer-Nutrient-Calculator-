...
const systems = [
  ...
  "Jacks 3-2-1 (Coming Soon)",
  "Athena Pro Line (Coming Soon)",
  "FoxFarm Solubles (Coming Soon)"
];
...
export default function Home() {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto bg-white shadow-xl rounded-xl border border-green-300">
